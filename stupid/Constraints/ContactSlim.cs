...
namespace stupid.Constraints
{
    public struct ContactSlim
    {
        ...
        public void SolveAll(ref RigidbodyData a, ref RigidbodyData b, in Vector3S normal, in f32 bias, in f32 friction)
        {
            ...
            var normalImpulse = normal * incremental;
            ...
            var newFrictionImpulse = MathS.Clamp(this.accumulatedFriction + incrementalFriction, -couloumbMax, couloumbMax);
            incrementalFriction = newFrictionImpulse - this.accumulatedFriction;
            this.accumulatedFriction = newFrictionImpulse;
            var tangentImpulse = this.tangent * incrementalFriction;

            var impulse = normalImpulse + tangentImpulse;
