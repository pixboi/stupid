...
namespace stupid.Colliders
{
    public static partial class CollisionMath
    {
        ...
        {
            var test = TestBoxVsSphere(box.collidable, sphere.collidable, box, sphere, out var contact, true);
            if (test == 1)
            {
                contacts[0] = contact;
                return 1;
        ...
        {
            var test = TestBoxVsSphere(sphere.collidable, box.collidable, box, sphere, out var contact, false);
            if (test == 1)
            {
                contacts[0] = contact;
                return 1;
